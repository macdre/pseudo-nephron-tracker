...
#    self.driver.find_element(By.CSS_SELECTOR, ".btn-outline-secondary").click()    
    self.driver.find_element(By.CSS_SELECTOR, "#average_dwell__dialog_ > div > div > div.b-form-spinbutton.form-control.d-inline-flex.flex-column.b-time-hours > button:nth-child(1)").click()
    self.driver.find_element(By.CSS_SELECTOR, "#average_dwell__dialog_ > div > div > div.b-form-spinbutton.form-control.d-inline-flex.flex-column.b-time-minutes > button:nth-child(1)").click()
    self.driver.find_element(By.CSS_SELECTOR, "#average_dwell__dialog_ > div > footer > div > button").click()
    ...
    # self.driver.find_element(By.CSS_SELECTOR, ".btn-outline-secondary").click()
    self.driver.find_element(By.CSS_SELECTOR, "#added_lost_dwell_value__dialog_ > div > div > div.b-form-spinbutton.form-control.d-inline-flex.flex-column.b-time-hours > button:nth-child(1)").click()
    self.driver.find_element(By.CSS_SELECTOR, "#added_lost_dwell_value__dialog_ > div > div > div.b-form-spinbutton.form-control.d-inline-flex.flex-column.b-time-minutes > button:nth-child(1)").click()
    self.driver.find_element(By.CSS_SELECTOR, "#added_lost_dwell_value__dialog_ > div > footer > div > button").click()
