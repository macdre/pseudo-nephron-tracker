...
gunicorn -b 0.0.0.0:5000 --chdir ./server app:app --log-level DEBUG --error-logfile /var/log/gunicorn.err.log --log-file /var/log/gunicorn.std.log --access-logfile /var/log/gunicorn.acc.log --daemon &
nginx -g 'daemon off;' &
