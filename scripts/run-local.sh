#!/bin/bash
export DATABASE_URL=postgresql://qvfbxecawwyrzq:fee378800db04735f3fbc7d5154fcec2f5d918068a3edf5d6796e6fed45378d8@ec2-18-235-20-228.compute-1.amazonaws.com:5432/d5svua9jn755cj
